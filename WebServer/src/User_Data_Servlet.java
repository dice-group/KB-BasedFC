...
public class User_Data_Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//pw is an object used to print on frontend
				...
				System.out.println("data has been stroed in their respective strings");
...
pw.println("Response from the microservice is: " + true_false_value); 		//doGet(request, response);
	}
	}
