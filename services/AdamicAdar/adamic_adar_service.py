...
class AdamicAdar(object):
	...
	def compute_adamic_adar(self, G, subs, preds, objs):
		"""
	...
	def stream(self, data):
		...
		# required for passing it to compute_adamic_adar
		...
		log.info('Computing AA for triple')
