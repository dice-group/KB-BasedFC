...
class Jaccard(object):
	...
	def compute_jaccard(self, G, subs, preds, objs):
		"""
	...
	def stream(self, data):
		...
		# required for passing it to compute_jaccard
		...
		log.info('Computing JC for triple')
		with warnings.catch_warnings():
			try:
				warnings.simplefilter("ignore")
				# compute jaccard
				scores, times = self.compute_jaccard(self.G, sid, pid, oid)
